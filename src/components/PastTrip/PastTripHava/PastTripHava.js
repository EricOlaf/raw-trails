...
import "./PastTripHava.css";

class PastTripHava extends Component {
  constructor() {
    super();
    this.state = {
      lat: 36.208281,
  ...
  render() {
    ...
    return (
      <div>
        <div className="ptImgOneHava">
          <div className="ptImgOneWordBoxHava">
            <div className="ptOneTitle">havasupai</div>
            <div className="ptOneDate">April-2018</div>
          </div>
        </div>
        <div className="ptDescContainer">
          <div className="ptDescTitle">Havasupai</div>
        ...
        <div className="ptImgThreeHava" />
        <div className="weatherContainer">
          <img
            className="weatherImg"
            src="https://res.cloudinary.com/rawtrails801/image/upload/v1538367866/Screen_Shot_2018-09-30_at_11.24.07_PM.png"
          />
        </div>
