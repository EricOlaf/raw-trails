...
import "./PastTripCour.css";

class PastTripCour extends Component {
  constructor() {
    super();
    this.state = {
      lat: 47.8,
  ...
  render() {
    ...
    return (
      <div>
        <div className="ptImgOneCo">
          <div className="ptImgOneWordBoxCo">
            <div className="ptOneTitle">coeur d'alene</div>
            <div className="ptOneDate">July-2018</div>
          </div>
        </div>
        <div className="ptDescContainer">
          <div className="ptDescTitle">Fishing Lake Hayden</div>
        ...
        <div className="ptImgThreeCo" />
        <div className="weatherContainer">
          <img
            className="weatherImg"
            src="https://res.cloudinary.com/rawtrails801/image/upload/v1538367818/Screen_Shot_2018-09-30_at_11.23.22_PM.png"
          />
        </div>
